...
int main(int argc, char** argv)
{
	...
	if(argc != 2)
	{
		cerr << endl << "Usage: rosrun autocalibration  autocalibration     numberofpose" << endl;
		cout<<argc<<endl;
		ros::shutdown();
		return 1;
	}
	...
	{
		cout<<"please move the robot and press Enter to continue,q to quit"<<endl;
		char c = getchar();
		if(c == 'q')
		{
			cout<<"quit safely"<< endl;
			return 0;
		}
		sleep(3);
		ros::spinOnce();
