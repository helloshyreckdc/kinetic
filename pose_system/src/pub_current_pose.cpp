...
int main(int argc, char** argv){
    ros::init(argc, argv, "pub_current_pose");
    ...
    ros::Publisher current_pose_pub = node.advertise<geometry_msgs::Transform>("/current_pose",10);
    ...
    while (node.ok()){
        ...
        current_pose = transformStamped.transform;
